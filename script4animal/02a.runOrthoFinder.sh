...
GENE_ORTHO_PY="/pathway/script4animal/ortho/gene_ortho.py"

ORTHO_SPECIES_TREE_PY="/pathway/script4animal/ortho/ortho_species_tree.py"
TREE_SPECIES_PY="/pathway/script4animal/ortho/tree_species.py"

COMBINE_FINAL_PY="/pathway/script4animal/ortho/gene_blast_combine_final.py"
