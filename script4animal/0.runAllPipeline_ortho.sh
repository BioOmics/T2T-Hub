...
RunStep "02a.runOrthoFinder" "/pathway/script4animal/02a.runOrthoFinder.sh"
...
RunStep "20.SaveResultToMySQL" "/pathway/script4animal/20.SaveResultToMySQL_ortho.sh"
